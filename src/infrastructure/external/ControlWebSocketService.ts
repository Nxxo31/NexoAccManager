...
interface PendingCommand {
  resolve: (value: IpcResultLike) => void;
...
function okResult(data?: unknown): IpcResultLike {
  return { success: true, data };
}

function errResult(error: string): IpcResultLike {
...
class ControlWebSocketServiceImpl {
  ...
  /** Snapshot del estado actual de la conexión (síncrono). */
